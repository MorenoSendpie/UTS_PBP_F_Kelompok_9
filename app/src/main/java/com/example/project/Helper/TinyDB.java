...
public class TinyDB {
    ...
    public ArrayList<SushiDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<SushiDomain> playerList =  new ArrayList<SushiDomain>();

        for(String jObjString : objStrings){
            SushiDomain player  = gson.fromJson(jObjString,  SushiDomain.class);
    ...
    public void putListObject(String key, ArrayList<SushiDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(SushiDomain player: playerList){
